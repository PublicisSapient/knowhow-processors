...
class GitLabRateLimitMonitorTest {
	...
	@InjectMocks private GitLabRateLimitMonitor gitLabRateLimitMonitor;
	...
	void setUp() {
		ReflectionTestUtils.setField(
				gitLabRateLimitMonitor, "gitlabApiUrl", "https://gitlab.com/api/v4");
	...
	@Test
	void testCheckRateLimit_WithNullToken_ReturnsUnauthenticatedLimits()
	...
	@Test
	void testCheckRateLimit_WithEmptyToken_ReturnsUnauthenticatedLimits()
			throws RateLimitExceededException {
	...
	void testCheckRateLimit_Success_ReturnsDefaultStatus() throws Exception {
		try (MockedConstruction<GitLabApi> mockedGitLabApi =
				mockConstruction(
						GitLabApi.class,
						(mock, context) -> {
