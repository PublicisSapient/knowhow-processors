...
class ServerBitbucketParserTest {
	...
	void testParseDiffToFileChanges_ValidDiff() throws Exception {
		String diffJson =
				"{\"diffs\":[{\"source\":{\"toString\":\"file.txt\"},\"hunks\":[{\"segments\":[{\"type\":\"ADDED\",\"lines\":[{\"destination\":1}]},{\"type\":\"REMOVED\",\"lines\":[{\"source\":1}]}]}]}]}";
	...
	void testParsePRDiffToFileChanges_ValidDiff() throws Exception {
		String diffJson =
				"{\"diffs\":[{\"hunks\":[{\"segments\":[{\"type\":\"ADDED\",\"lines\":[{},{},{}]},{\"type\":\"REMOVED\",\"lines\":[{},{}]}]}]}]}";
	...
	void testParsePullRequestNode_ValidNode() throws Exception {
		String prJson =
				"{\"id\":1,\"title\":\"Test PR\",\"state\":\"OPEN\",\"createdDate\":1609459200000,\"updatedDate\":1609545600000,\"author\":{\"user\":{\"name\":\"testuser\"}},\"fromRef\":{\"displayId\":\"feature\"},\"toRef\":{\"displayId\":\"main\"},\"links\":{\"self\":[{\"href\":\"http://server/projects/TEST/repos/repo/pull-requests/1\"}]}}";
	...
	void testParseCommitNode_ValidNode() throws Exception {
		String commitJson =
				"{\"id\":\"abc123\",\"authorTimestamp\":1609459200000,\"message\":\"Test commit\",\"author\":{\"name\":\"Test User\",\"emailAddress\":\"test@example.com\"}}";
	...
	void testParseRepositoryData_ValidNode() throws Exception {
		String repoJson =
				"{\"name\":\"test-repo\",\"links\":{\"self\":[{\"href\":\"http://server/rest/api/1.0/projects/TEST/repos/test-repo\"}]}}";
	...
	void testParseRepositoryBranchData_ValidNode() throws Exception {
		...
		ScmBranch result =
				parser.parseRepositoryBranchData(
						mockClient, node, "TEST", "repo", LocalDateTime.of(2023, 1, 1, 0, 0));
		assertNotNull(result);
	}
}
