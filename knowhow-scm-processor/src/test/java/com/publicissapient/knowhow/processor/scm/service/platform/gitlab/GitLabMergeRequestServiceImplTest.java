...
class GitLabMergeRequestServiceImplTest {
	...
	@Mock private GitLabCommonHelper commonHelper;
	...
	void fetchMergeRequests_success() throws Exception {
		...
		when(gitLabClient.fetchMergeRequests(
		...
		when(gitLabClient.getPrPickUpTimeStamp(
						anyString(), anyString(), anyString(), anyString(), anyLong()))
				.thenReturn(0L);
		when(gitLabClient.fetchMergeRequestChanges(
						anyString(), anyString(), anyLong(), anyString(), anyString()))
				.thenReturn(new ArrayList<>());
		when(gitLabClient.fetchMergeRequestCommits(
						anyString(), anyString(), anyLong(), anyString(), anyString()))
				.thenReturn(new ArrayList<>());
