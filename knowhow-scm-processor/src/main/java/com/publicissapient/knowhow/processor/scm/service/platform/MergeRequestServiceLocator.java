...
public class MergeRequestServiceLocator {
	...
	@Autowired
	public MergeRequestServiceLocator(
			Map<String, GitPlatformMergeRequestService> mergeRequestServices) {
		this.mergeRequestServices = mergeRequestServices;
		log.info(
				"MergeRequestServiceLocator initialized with {} services", mergeRequestServices.size());
	}
