 ...
 * <ul>
 *   <li>Retrieving KPI data from various sources (Jira, Sonar, Jenkins, etc.)</li>
 *   <li>Calculating category-wise maturity scores based on configured weights</li>
 ...
 * <ul>
 *   <li>Maturity scores are calculated per category (quality, velocity, dora, etc.)</li>
 *   <li>Each category score is the average of its constituent KPI maturity values</li>
 *   <li>Efficiency score is a weighted sum of category scores with configurable weights</li>
 ...
 *   <li>Maturity calculation weights must be defined in application configuration</li>
...
public class KpiMaturityCalculationService {
	 ...
	 * </ul>
	 *
	 * @param projectInput the project data including organization hierarchy information and sprint details
	 * @return calculated KPI maturity object with scores and efficiency metrics,
	 ...
	 *   <li>Maturity levels are assigned as M1, M2, M3, M4, M5 based on score ceiling</li>
	 * </ul>
	...
	/**
	 * Calculates the overall efficiency score based on category maturity scores and configured weights.
	 *
	 ...
	 *   <li>Efficiency percentage = (efficiency_score / max_possible_score) × 100</li>
	 * </ul>
	 *
	 ...
	 * <ul>
	 *   <li><strong>Time-based KPIs</strong> (MONTH, WEEK, DAY): Use project-level hierarchy with date ranges</li>
	 *   <li><strong>Sprint-based KPIs</strong> (SPRINT, ITERATION, PI): Use sprint-level hierarchy with sprint IDs</li>
	 * </ul>
	 *
	 * <p><strong>Request Construction Logic:</strong>
	 * <ul>
	 *   <li>KPIs are grouped by source (Jira, Sonar, Jenkins, etc.)</li>
	 *   <li>Granularity is determined from the first KPI's xAxisLabel in each group</li>
	 ...
	 * <ol>
	 *   <li>Fetch KPIs supporting maturity calculation for SCRUM methodology</li>
	 ...
	 *
	 * <p>Maturity calculation requires at least one KPI element with a numeric
	 * overall maturity value. This method validates data availability before
	 * proceeding with expensive calculation operations.
	 *
