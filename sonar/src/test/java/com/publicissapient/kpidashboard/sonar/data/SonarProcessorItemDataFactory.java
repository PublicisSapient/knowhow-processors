...
package com.publicissapient.kpidashboard.sonar.data;
...
public class SonarProcessorItemDataFactory {
	...
	public static SonarProcessorItemDataFactory newInstance(String filePath) {
		...
		SonarProcessorItemDataFactory factory = new SonarProcessorItemDataFactory();
		factory.createObjectMapper();
		factory.init(filePath);
		return factory;
	}

	public static SonarProcessorItemDataFactory newInstance() {
