...
public class GitLabCommonHelper {
	...
	private static final String[] BINARY_EXTENSIONS = {
		".jpg", ".jpeg", ".png", ".gif", ".bmp", ".ico", ".svg", ".pdf", ".zip", ".tar", ".gz", ".rar",
		".7z", ".exe", ".dll", ".so", ".dylib", ".class", ".jar"
	};
	...
	public void setMergeRequestState(
	...
	public void setMergeRequestTimestamps(
			ScmMergeRequests.ScmMergeRequestsBuilder builder,
			org.gitlab4j.api.models.MergeRequest gitlabMr) {
		if (gitlabMr.getMergedAt() != null) {
			builder.mergedAt(
					gitlabMr.getMergedAt().toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime());
		}
		if (gitlabMr.getClosedAt() != null) {
	...
	public void setMergeRequestAuthor(
			ScmMergeRequests.ScmMergeRequestsBuilder builder,
			org.gitlab4j.api.models.MergeRequest gitlabMr) {
