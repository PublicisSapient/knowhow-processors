...
public class CreateJiraIssueReleaseStatusImplTest {
	...
	@Mock private MetadataRestClient metadataRestClient;

	@Mock Promise<Iterable<Status>> metaDataStatusPromise;

	@InjectMocks private CreateJiraIssueReleaseStatusImpl createJiraIssueReleaseStatus;
	...
	@Test
	public void testProcessAndSaveProjectStatusCategory_NewStatusCategory()
		...
		JiraIssueReleaseStatus jiraIssueReleaseStatus =
				JiraIssueReleaseStatus.builder()
						.basicProjectConfigId("project123")
						.toDoList(map)
						.closedList(new HashMap<>())
						.inProgressList(new HashMap<>())
						.build();
	...
	private List<Status> createMockStatusList() throws URISyntaxException {
		StatusCategory statusCategory =
				new StatusCategory(new URI("self"), "To Do", 0l, "key", "colour");
