...
public final class Constants {
	...
	private static final String[] ITEMS_TREE = {
		"user", "author[fullName]", REVISION, "id", "msg", TIMESTAMP, "date", "paths[file]"
	};
	private static final String[] BUILD_TREE = {
		...
		"changeSet[items[" + StringUtils.join(ITEMS_TREE, ",") + "]",
		"kind",
		"revisions[module,revision]]",
		"actions[lastBuiltRevision[SHA1,branch[SHA1,name]],remoteUrls]"
	};
	public static final String BUILD_URL_END_POINT =
			"/api/json?tree=" + StringUtils.join(BUILD_TREE, ",");
	private static final String[] JOB_BUILD_TREE = {
		NUMBER, URL, TIMESTAMP, DURATION, BUILDING, RESULT, "culprits[fullName]"
	};
	public static final String JOB_FIELDS =
			"name,url,builds["
					+ StringUtils.join(JOB_BUILD_TREE, ",")
