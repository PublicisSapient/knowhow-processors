...
/** Updates data references between entities. Follows Single Responsibility Principle. */
@Component
@Slf4j
public class DataReferenceUpdater {
	 ...
	 */
	public void updateCommitsWithUserReferences(
			List<ScmCommits> commitDetails, Map<String, User> userMap, String repositoryName) {
	 ...
	 * @param repositoryName the repository name
	 */
	public void updateMergeRequestsWithUserReferences(
			List<ScmMergeRequests> mergeRequests, Map<String, User> userMap, String repositoryName) {
	...
	/**
	 * Finds a user by name in the user map. CHANGE: Extracted method to eliminate duplicate code
	 *
	...
	/**
	 * Creates and sets the author user for a merge request. CHANGE: Extracted method to improve
	...
	/**
	 * Sets reviewer references for a merge request. CHANGE: Extracted method to improve readability
	 *
	 * @param mr the merge request
	 * @param userMap the map of users
	 */
