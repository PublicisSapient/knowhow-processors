 ...
 *
 * <p>This configuration provides comprehensive API documentation including: - API information and
 * metadata - Server configurations for different environments - Tag definitions for endpoint
 * grouping - Contact and license information
 */
@Configuration
public class OpenApiConfig {
	...
	public OpenAPI gitScannerOpenAPI() {
		return new OpenAPI().info(createApiInfo()).servers(createServerList()).tags(createTagList());
	}
	...
	private List<Server> createServerList() {
		return List.of(
				...
				new Server().url("https://api-dev.gitscanner.com").description("Development Server"),
				new Server().url("https://api.gitscanner.com").description("Production Server"));
	}
