...
@Tag(
		name = "Job Management",
		description =
				"APIs for managing and controlling job execution, including running jobs and managing their enabled/disabled state")
public class JobController {
	...
	@Operation(
			...
			description =
					"Triggers the execution of a specified job asynchronously. The job will be queued for execution and a response with execution details will be returned immediately.",
			operationId = "runJob")
	@ApiResponses(
			value = {
				@ApiResponse(
						responseCode = "202",
						description = "Job execution request accepted and queued successfully",
						content =
								@Content(
										mediaType = "application/json",
										schema = @Schema(implementation = JobExecutionResponseRecord.class),
										examples =
												@ExampleObject(
				...
				@ApiResponse(
						responseCode = "400",
						description = "Invalid job name or job configuration error",
						content =
								@Content(
										mediaType = "application/json",
										examples =
				...
				@ApiResponse(
						responseCode = "409",
						description = "Job is already running or disabled",
						content =
								@Content(
										mediaType = "application/json",
										examples =
	...
	public ResponseEntity<JobExecutionResponseRecord> runJob(
			@Parameter(
							name = "jobName",
							description =
									"The unique name/identifier of the job to execute. Must be a valid, existing job name.",
							required = true,
							example = "data-sync-job",
							schema = @Schema(type = "string", pattern = "^[a-zA-Z0-9-_]+$"))
					@PathVariable
					String jobName) {
	...
	@Operation(
			...
			description =
					"Enables a previously disabled job, allowing it to be executed. An enabled job can be triggered manually or by scheduled triggers.",
			...
			value = {
				@ApiResponse(
						...
						content =
								@Content(
										mediaType = "application/json",
										schema = @Schema(implementation = JobResponseRecord.class),
										examples =
												@ExampleObject(
														name = "Job enabled successfully",
														value =
																"""
					{
							"jobName": "data-sync-job",
				...
				@ApiResponse(
						responseCode = "400",
						description = "Invalid job name or job is already enabled",
						content =
								@Content(
										mediaType = "application/json",
										examples =
												@ExampleObject(
														name = "Job already enabled",
														value =
																"""
					{
				...
				@ApiResponse(
						responseCode = "500",
						description = "Internal server error during job enable operation",
						content =
								@Content(
										mediaType = "application/json",
										examples =
	...
	public ResponseEntity<JobResponseRecord> enableJob(
			@Parameter(
							name = "jobName",
							description =
									"The unique name/identifier of the job to disable. Must be a valid, existing job name.",
							required = true,
							example = "data-sync-job",
							schema = @Schema(type = "string", pattern = "^[a-zA-Z0-9-_]+$"))
					@PathVariable
	...
	@Operation(
			...
			description =
					"Disables an active job, preventing it from being executed until re-enabled. Currently running instances will complete, but no new executions will be allowed.",
	...
	@ApiResponses(
			value = {
				@ApiResponse(
						...
						content =
								@Content(
										...
										examples =
												@ExampleObject(
														name = "Job disabled successfully",
														value =
																"""
					{
							"jobName": "data-sync-job",
				...
				@ApiResponse(
						responseCode = "400",
						description = "Invalid job name or job is already disabled",
						content =
								@Content(
										mediaType = "application/json",
										examples =
												@ExampleObject(
														name = "Job already disabled",
														value =
																"""
					{
				...
				@ApiResponse(
						responseCode = "409",
						description = "Job cannot be disabled while running",
						content =
								@Content(
										mediaType = "application/json",
										examples =
												@ExampleObject(
														name = "Job currently running",
														value =
																"""
					{
				...
				@ApiResponse(
						responseCode = "500",
						description = "Internal server error during job disable operation",
						content =
								@Content(
										mediaType = "application/json",
										examples =
