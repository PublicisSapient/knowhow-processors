 ...
 * threshold (default 80%) to prevent hitting the actual rate limit and
...
public class RateLimitExceededException extends DataProcessingException {
    ...
    public RateLimitExceededException(String platform, int currentUsage, int totalLimit, 
                                    double thresholdPercentage, long resetTime) {
        super(String.format("Rate limit threshold (%.0f%%) exceeded for %s platform. " +
