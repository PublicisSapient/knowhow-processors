...
public interface GitPlatformService {
	 ...
	 *            the repository name
	 * @param branchName
	 *            the branch name (optional, null for default branch)
	 * @param token
	 *            the access token for authentication
	 * @param since
	 *            the start date for commits (optional)
	 * @param until
	 *            the end date for commits (optional)
	 ...
	 *            the repository name
	 * @param branchName
	 *            the target branch name to filter merge requests (optional, null
	 *            for all branches)
	 * @param token
	 *            the access token for authentication
	 * @param since
	 *            the start date for merge requests (optional)
	 * @param until
	 *            the end date for merge requests (optional)
	 ...
	 *            for all branches)
	 * @param state
	 *            the merge request state (open, closed, merged, all)
	 * @param token
	 *            the access token for authentication
	 * @param since
	 *            the start date for merge requests (optional)
	 ...
	 *             if API call fails
	 */
	List<ScmMergeRequests> fetchMergeRequestsByState(String toolConfigId, String owner, String repository,
	 ...
	 *            the access token for authentication
	 * @param limit
	 *            the maximum number of merge requests to fetch
	 * @return list of latest merge requests
	 * @throws PlatformApiException
	 *             if API call fails
	 */
	List<ScmMergeRequests> fetchLatestMergeRequests(String toolConfigId, String owner, String repository,
	...
	class RateLimitInfo {
		...
		public String toString() {
			return String.format("RateLimitInfo{limit=%d, remaining=%d, resetTime=%s, isLimited=%s}", limit, remaining,
					resetTime, isLimited);
		}
	}
}