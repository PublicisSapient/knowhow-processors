...
public class JobListenerScrumTest {
	...
	@Mock private ProjectBasicConfigRepository projectBasicConfigRepo;
	...
	public void testAfterJob_Success() {
		...
		verify(processorExecutionTraceLogRepo)
	...
	public void testAfterJob_NullProjectConfig() throws UnknownHostException {
		...
		// Verify notification was not sent (null project config with enabled notification should not
		// send)
		verify(handler, never())
				.sendEmailToProjectAdminAndSuperAdmin(
						anyString(), anyString(), anyString(), anyString(), anyString());
