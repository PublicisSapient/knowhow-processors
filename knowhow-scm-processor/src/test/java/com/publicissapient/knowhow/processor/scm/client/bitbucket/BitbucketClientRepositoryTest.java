...
class BitbucketClientRepositoryTest {
	...
	@InjectMocks private BitbucketClient bitbucketClient;
	...
	void setUp() {
		ReflectionTestUtils.setField(
				bitbucketClient, "defaultBitbucketApiUrl", "https://api.bitbucket.org/2.0");
	...
	void testGetNextBranchPageUrl_WithNullRootNode_ReturnsNull() throws Exception {
		String result =
				ReflectionTestUtils.invokeMethod(bitbucketClient, "getNextBranchPageUrl", (JsonNode) null);
		assertNull(result);
	}
	...
	void testGetNextBranchPageUrl_WithMissingNextNode_ReturnsNull() throws Exception {
		...
		String result =
				ReflectionTestUtils.invokeMethod(bitbucketClient, "getNextBranchPageUrl", rootNode);
		assertNull(result);
	}
	...
	void testGetNextBranchPageUrl_WithValidHttpUrl_ReturnsNormalizedUrl() throws Exception {
		...
		JsonNode rootNode =
				mapper.readTree(
						"{\"next\": \"https://api.bitbucket.org/2.0/repositories/owner/repo/refs/branches?page=2\"}");
	...
	void testGetNextBranchPageUrl_WithRelativeUrl_ReturnsAsIs() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		JsonNode rootNode =
				mapper.readTree("{\"next\": \"/repositories/owner/repo/refs/branches?page=2\"}");
	...
	void testFetchServerBranches_WithException_LogsError() throws Exception {
		...
		ReflectionTestUtils.invokeMethod(
				...
				"TEST",
				LocalDateTime.now(),
				bitbucketClient.getBitbucketParser(false));
	...
	void testFetchServerBranches_Success() throws Exception {
		...
		String branchResponse =
				"{\"values\":[{\"displayId\":\"main\",\"latestCommit\":\"abc123\"}],\"isLastPage\":true}";
	...
	void testFetchRepositories_BitbucketCloud() throws Exception {
		...
		String repoResponse =
				"{\"values\":[{\"name\":\"test-repo\",\"updated_on\":\"2024-01-01T00:00:00Z\",\"links\":{\"html\":{\"href\":\"https://bitbucket.org/owner/test-repo\"}},\"owner\":{\"username\":\"owner\"}}],\"next\":null}";
		String branchResponse =
				"{\"values\":[{\"name\":\"main\",\"target\":{\"date\":\"2024-01-01T00:00:00Z\"}}],\"next\":null}";
	...
	void testFetchRepositories_BitbucketServer() throws Exception {
		...
		String projectResponse =
				"{\"values\":[{\"key\":\"TEST\",\"name\":\"Test Project\"}],\"isLastPage\":true}";
		String repoResponse =
				"{\"values\":[{\"name\":\"test-repo\",\"links\":{\"self\":[{\"href\":\"http://server/rest/api/1.0/projects/TEST/repos/test-repo\"}]}}],\"isLastPage\":true}";
	...
	void testFetchRepositories_Exception() {
		...
		doThrow(new RuntimeException("Connection error"))
				.when(spyClient)
				.getBitbucketClient(anyString(), anyString(), anyString());
	...
	void testGetBitbucketClient() {
		...
		WebClient result =
				bitbucketClient.getBitbucketClient("user", "pass", "https://api.bitbucket.org/2.0");
	...
	void testGetBitbucketClientFromRepoUrl_Cloud() {
		...
		WebClient result =
				spyClient.getBitbucketClientFromRepoUrl("user", "pass", "https://bitbucket.org/owner/repo");
	...
	void testGetBitbucketClientFromRepoUrl_Server() {
		...
		WebClient result =
				spyClient.getBitbucketClientFromRepoUrl(
						"user", "pass", "http://server/scm/project/repo.git");
	...
	void testTestConnection_Success() {
		...
		when(mockHeadersSpec.retrieve()).thenReturn(mockResponseSpec);
		when(mockResponseSpec.bodyToMono(String.class))
				.thenReturn(Mono.just("{\"username\":\"test\"}"));
	...
	void testNormalizeCloudApiUrl_WithoutHttp() throws Exception {
		String result =
				ReflectionTestUtils.invokeMethod(
						bitbucketClient, "normalizeCloudApiUrl", "/repositories/owner/repo");
		assertEquals("/repositories/owner/repo", result);
	}
	...
	void testNormalizeCloudApiUrl_Null() throws Exception {
		String result =
				ReflectionTestUtils.invokeMethod(bitbucketClient, "normalizeCloudApiUrl", (String) null);
		assertNull(result);
	}
	...
	void testExtractServerApiUrl_WithScm() throws Exception {
		String result =
				ReflectionTestUtils.invokeMethod(
						bitbucketClient, "extractServerApiUrl", "http://server/scm/project/repo.git");
		assertEquals("http://server/rest/api/1.0", result);
	}
	...
	void testExtractServerApiUrl_WithProjects() throws Exception {
		String result =
				ReflectionTestUtils.invokeMethod(
						bitbucketClient, "extractServerApiUrl", "http://server/projects/TEST/repos/repo");
		assertEquals("http://server/rest/api/1.0", result);
	}
	...
	void testExtractServerApiUrl_WithTrailingSlash() throws Exception {
		String result =
				ReflectionTestUtils.invokeMethod(
						bitbucketClient, "extractServerApiUrl", "http://server/scm/project/repo/");
		assertEquals("http://server/rest/api/1.0", result);
	}
	...
	void testFetchCommits_Cloud_Success() throws Exception {
		...
		String commitResponse =
				"{\"values\":[{\"hash\":\"abc123\",\"date\":\"2024-01-01T00:00:00Z\",\"message\":\"test commit\",\"author\":{\"raw\":\"Test User <test@example.com>\"}}],\"next\":null}";

		doReturn(mockClient)
				.when(spyClient)
				.getBitbucketClientFromRepoUrl(anyString(), anyString(), anyString());
		doNothing()
				.when(rateLimitService)
				.checkRateLimit(anyString(), anyString(), anyString(), anyString());
		when(mockClient.get()).thenReturn(mockUriSpec);
		when(mockUriSpec.uri(anyString())).thenReturn(mockHeadersSpec);
		when(mockHeadersSpec.retrieve()).thenReturn(mockResponseSpec);
		when(mockResponseSpec.bodyToMono(String.class)).thenReturn(Mono.just(commitResponse));

		List<BitbucketClient.BitbucketCommit> result =
				spyClient.fetchCommits(
						"owner",
						"repo",
						"main",
						"user",
	...
	void testFetchCommits_Server_Success() throws Exception {
		...
		String commitResponse =
				"{\"values\":[{\"id\":\"abc123\",\"authorTimestamp\":1609459200000,\"message\":\"test commit\",\"author\":{\"name\":\"Test User\",\"emailAddress\":\"test@example.com\"}}],\"isLastPage\":true}";
	...
	void testFetchCommits_WithPagination() throws Exception {
		...
		String page1 =
				"{\"values\":[{\"hash\":\"abc123\",\"date\":\"2024-01-01T00:00:00Z\",\"message\":\"commit1\",\"author\":{\"raw\":\"User <user@example.com>\"}}],\"next\":\"https://api.bitbucket.org/2.0/repositories/owner/repo/commits?page=2\"}";
		String page2 =
				"{\"values\":[{\"hash\":\"def456\",\"date\":\"2024-01-02T00:00:00Z\",\"message\":\"commit2\",\"author\":{\"raw\":\"User <user@example.com>\"}}],\"next\":null}";
	...
	void testFetchCommits_WithDateFilter() throws Exception {
		...
		String commitResponse =
				"{\"values\":[{\"hash\":\"abc123\",\"date\":\"2024-01-15T00:00:00Z\",\"message\":\"recent\",\"author\":{\"raw\":\"User <user@example.com>\"}},{\"hash\":\"old123\",\"date\":\"2023-12-01T00:00:00Z\",\"message\":\"old\",\"author\":{\"raw\":\"User <user@example.com>\"}}],\"next\":null}";
	...
	void testFetchPullRequests_Cloud_Success() throws Exception {
		...
		String prResponse =
				"{\"values\":[{\"id\":1,\"title\":\"Test PR\",\"state\":\"OPEN\",\"created_on\":\"2024-01-01T00:00:00Z\",\"updated_on\":\"2024-01-02T00:00:00Z\",\"author\":{\"display_name\":\"Test User\"},\"source\":{\"branch\":{\"name\":\"feature\"}},\"destination\":{\"branch\":{\"name\":\"main\"}},\"links\":{\"self\":{\"href\":\"https://bitbucket.org/owner/repo/pull-requests/1\"}}}],\"next\":null}";
		...
		List<BitbucketClient.BitbucketPullRequest> result =
				spyClient.fetchPullRequests(
						"owner",
						"repo",
						"main",
						"user",
	...
	void testFetchPullRequests_Server_Success() throws Exception {
		...
		String prResponse =
				"{\"values\":[{\"id\":1,\"title\":\"Test PR\",\"state\":\"OPEN\",\"createdDate\":1609459200000,\"updatedDate\":1609545600000,\"author\":{\"user\":{\"name\":\"testuser\"}},\"fromRef\":{\"displayId\":\"feature\"},\"toRef\":{\"displayId\":\"main\"},\"links\":{\"self\":[{\"href\":\"http://server/projects/TEST/repos/repo/pull-requests/1\"}]}}],\"isLastPage\":true}";
		String activityResponse =
				"{\"values\":[{\"action\":\"MERGED\",\"createdDate\":1609545600000}],\"isLastPage\":true}";
	...
	void testFetchPullRequests_WithPagination() throws Exception {
		...
		String page1 =
				"{\"values\":[{\"id\":1,\"title\":\"PR1\",\"state\":\"OPEN\",\"created_on\":\"2024-01-01T00:00:00Z\",\"updated_on\":\"2024-01-02T00:00:00Z\",\"author\":{\"display_name\":\"User\"},\"source\":{\"branch\":{\"name\":\"f1\"}},\"destination\":{\"branch\":{\"name\":\"main\"}},\"links\":{\"self\":{\"href\":\"https://bitbucket.org/owner/repo/pull-requests/1\"}}}],\"next\":\"https://api.bitbucket.org/2.0/repositories/owner/repo/pullrequests?page=2\"}";
		String page2 =
				"{\"values\":[{\"id\":2,\"title\":\"PR2\",\"state\":\"OPEN\",\"created_on\":\"2024-01-01T00:00:00Z\",\"updated_on\":\"2024-01-02T00:00:00Z\",\"author\":{\"display_name\":\"User\"},\"source\":{\"branch\":{\"name\":\"f2\"}},\"destination\":{\"branch\":{\"name\":\"main\"}},\"links\":{\"self\":{\"href\":\"https://bitbucket.org/owner/repo/pull-requests/2\"}}}],\"next\":null}";
	...
	void testFetchLatestPullRequests_Success() throws Exception {
		...
		String prResponse =
				"{\"values\":[{\"id\":1,\"title\":\"Latest PR\",\"state\":\"OPEN\",\"created_on\":\"2024-01-01T00:00:00Z\",\"updated_on\":\"2024-01-02T00:00:00Z\",\"author\":{\"display_name\":\"User\"},\"source\":{\"branch\":{\"name\":\"feature\"}},\"destination\":{\"branch\":{\"name\":\"main\"}},\"links\":{\"self\":{\"href\":\"https://bitbucket.org/owner/repo/pull-requests/1\"}}}]}";
		...
		List<BitbucketClient.BitbucketPullRequest> result =
				spyClient.fetchLatestPullRequests(
	...
	void testFetchCommitDiffs_Exception() {
		...
		assertThrows(
				PlatformApiException.class,
				() -> {
					spyClient.fetchCommitDiffs(
							"owner", "repo", "abc123", "user", "pass", "https://bitbucket.org/owner/repo");
				});
	}
	...
	void testFetchPullRequestDiffs_Exception() {
		...
		assertThrows(
				PlatformApiException.class,
				() -> {
					spyClient.fetchPullRequestDiffs(
							"owner", "repo", 1L, "user", "pass", "https://bitbucket.org/owner/repo");
				});
	}
}
