...
public class ProcessorAsynchJiraRestClientFactory extends AsynchronousJiraRestClientFactory {
	...
	public ProcessorJiraRestClient createWithBasicHttpAuthentication(
			...
			JiraProcessorConfig jiraProcessorConfig) {
		return create(
				serverUri, new BasicHttpAuthenticationHandler(username, password), jiraProcessorConfig);
	}
	 ...
	 * @return ProcessorJiraRestClient
	 */
	public ProcessorJiraRestClient createWithBearerTokenAuthentication(
			final URI serverUri, final String bearerToken, JiraProcessorConfig jiraProcessorConfig) {
		return create(
				serverUri, new BearerTokenAuthenticationHandler(bearerToken), jiraProcessorConfig);
	}
	 ...
	 * @return ProcessorJiraRestClient
	 */
	public ProcessorJiraRestClient createWithAuthenticationCookies(
			final URI serverUri, final String authCookies, JiraProcessorConfig jiraProcessorConfig) {
