...
public class HierarchicalRequirement {
	...
	/**
	 * Custom deserializer for the Defects field to handle various JSON formats This makes the code
	 * more robust against API response variations
	 */
	public static class DefectsDeserializer
			extends com.fasterxml.jackson.databind.JsonDeserializer<List<HierarchicalRequirement>> {
		@Override
		public List<HierarchicalRequirement> deserialize(
							...
							while ((token = p.nextToken()) != com.fasterxml.jackson.core.JsonToken.END_OBJECT) {
								if (token == com.fasterxml.jackson.core.JsonToken.FIELD_NAME) {
									...
									if ("_ref".equals(fieldName)
											&& token == com.fasterxml.jackson.core.JsonToken.VALUE_STRING) {
										defect.setRef(p.getValueAsString());
									} else if ("FormattedID".equals(fieldName)
											&& token == com.fasterxml.jackson.core.JsonToken.VALUE_STRING) {
