...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponseRecord> handleBadRequestException(
			BadRequestException exception) {
		return logAndBuildResponse(exception, HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(ResourceNotFoundException.class)
	public ResponseEntity<ErrorResponseRecord> handleResourceNotFoundException(
	...
	public ResponseEntity<ErrorResponseRecord> handleInternalServerErrorException(
	...
	public ResponseEntity<ErrorResponseRecord> handleGeneralException(Exception exception) {
		return logAndBuildResponse(
				exception, exception.getMessage(), GENERIC_ERROR_MESSAGE, HttpStatus.INTERNAL_SERVER_ERROR);
	}
