...
class CloudBitBucketParserTest {
	...
	void testParsePullRequestNode_ValidNode() throws Exception {
		String prJson =
				"{\"id\":1,\"title\":\"Test PR\",\"state\":\"OPEN\",\"created_on\":\"2024-01-01T00:00:00Z\",\"updated_on\":\"2024-01-02T00:00:00Z\",\"author\":{\"display_name\":\"User\"},\"source\":{\"branch\":{\"name\":\"feature\"}},\"destination\":{\"branch\":{\"name\":\"main\"}},\"links\":{\"self\":{\"href\":\"https://bitbucket.org/owner/repo/pull-requests/1\"}}}";
	...
	void testParseCommitNode_ValidNode() throws Exception {
		String commitJson =
				"{\"hash\":\"abc123\",\"date\":\"2024-01-01T00:00:00Z\",\"message\":\"Test commit\",\"author\":{\"raw\":\"User <user@example.com>\"}}";
	...
	void testParseRepositoryData_ValidNode() throws Exception {
		String repoJson =
				"{\"name\":\"test-repo\",\"updated_on\":\"2024-01-01T00:00:00+00:00\",\"links\":{\"clone\":{\"href\":\"https://bitbucket.org/owner/test-repo\"}}}";
	...
	void testParseRepositoryBranchData_ValidNode() throws Exception {
		...
		ScmBranch result =
				parser.parseRepositoryBranchData(
						null, node, null, null, LocalDateTime.of(2023, 1, 1, 0, 0));
		assertNotNull(result);
	}
}
