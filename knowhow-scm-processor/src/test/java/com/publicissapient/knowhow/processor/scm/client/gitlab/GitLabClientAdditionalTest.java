...
class GitLabClientAdditionalTest {
	...
	void testGetPrPickUpTimeStamp_Success() throws Exception {
		...
		long result =
				spyClient.getPrPickUpTimeStamp(TEST_ORG, TEST_REPO, TEST_TOKEN, TEST_REPO_URL, 1L);
	...
	void testFetchCommitDiffs_Success() throws Exception {
		...
		List<Diff> result =
				spyClient.fetchCommitDiffs(TEST_ORG, TEST_REPO, "abc123", TEST_TOKEN, TEST_REPO_URL);
	...
	void testFetchMergeRequestChanges_Success() throws Exception {
		...
		List<Diff> result =
				spyClient.fetchMergeRequestChanges(TEST_ORG, TEST_REPO, 1L, TEST_TOKEN, TEST_REPO_URL);
	...
	void testFetchMergeRequestCommits_Success() throws Exception {
		...
		List<Commit> result =
				spyClient.fetchMergeRequestCommits(TEST_ORG, TEST_REPO, 1L, TEST_TOKEN, TEST_REPO_URL);
